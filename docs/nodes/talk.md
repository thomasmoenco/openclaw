...
| Key                                      | Default                                    | Notes                                                                                                                                                                                                                                                                                   |
| ---------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `agentId`                                | sole configured agent                      | Owns Talk sessions created without an explicit agent-scoped session key. Required for unscoped Talk work in a multi-agent fleet.                                                                                                                                                        |
